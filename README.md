...
3. [Deep Neural Networks](https://github.com/ingambe/PracticumAAUDeepLearning/tree/master/3-Deep-networks)
   0. [Model Interpretability with Captum](https://github.com/ingambe/PracticumAAUDeepLearning/blob/master/3-Deep-networks/Slides/0-Model%20Interpretability.ipynb)
   1. [Multi Layers Perceptron](https://github.com/ingambe/PracticumAAUDeepLearning/blob/master/3-Deep-networks/Slides/1-MLP.ipynb)
   2. [Regularization](https://github.com/ingambe/PracticumAAUDeepLearning/blob/master/3-Deep-networks/Slides/2-Regularization.ipynb)
   3. [Visualize Neural Networks](https://github.com/ingambe/PracticumAAUDeepLearning/blob/master/3-Deep-networks/Slides/3-Visualize%20NN.ipynb)
   4. [Advanced Autograd](https://github.com/ingambe/PracticumAAUDeepLearning/blob/master/3-Deep-networks/Slides/4-advanced-autograd.pdf)
